...
drop policy if exists "broadcast_lists_select_owner" on public.broadcast_lists;
create policy "broadcast_lists_select_owner" on public.broadcast_lists
  for select to authenticated using (owner_id = auth.uid());
drop policy if exists "broadcast_lists_insert_owner" on public.broadcast_lists;
create policy "broadcast_lists_insert_owner" on public.broadcast_lists
  for insert to authenticated with check (owner_id = auth.uid());
drop policy if exists "broadcast_lists_update_owner" on public.broadcast_lists;
create policy "broadcast_lists_update_owner" on public.broadcast_lists
  for update to authenticated using (owner_id = auth.uid()) with check (owner_id = auth.uid());
drop policy if exists "broadcast_lists_delete_owner" on public.broadcast_lists;
create policy "broadcast_lists_delete_owner" on public.broadcast_lists
  for delete to authenticated using (owner_id = auth.uid());

drop policy if exists "broadcast_list_members_select_owner" on public.broadcast_list_members;
...
drop policy if exists "broadcast_list_members_insert_owner" on public.broadcast_list_members;
create policy "broadcast_list_members_insert_owner" on public.broadcast_list_members
  for insert to authenticated with check (
    exists (select 1 from public.broadcast_lists bl where bl.id = list_id and bl.owner_id = auth.uid())
  );
drop policy if exists "broadcast_list_members_delete_owner" on public.broadcast_list_members;
create policy "broadcast_list_members_delete_owner" on public.broadcast_list_members
  for delete to authenticated using (
    exists (select 1 from public.broadcast_lists bl where bl.id = list_id and bl.owner_id = auth.uid())
  );

drop policy if exists "broadcast_sends_select_sender" on public.broadcast_sends;
...
drop policy if exists "broadcast_sends_insert_sender" on public.broadcast_sends;
create policy "broadcast_sends_insert_sender" on public.broadcast_sends
  for insert to authenticated with check (sender_id = auth.uid());

drop policy if exists "broadcast_send_targets_select_sender" on public.broadcast_send_targets;
...
drop policy if exists "broadcast_send_targets_insert_sender" on public.broadcast_send_targets;
